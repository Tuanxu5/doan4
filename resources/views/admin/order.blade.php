            ...
            <div class="w3layouts-glyphicon">
                <div class="grid_3 grid_4">
                    <div class="input-group" style="margin-left: 907px;">
                        <input ng-model="search" style="width: 200px;height: 36px;margin-top: -7px;" type="text" class="form-control" placeholder="Username">
                            ...
                            <div>
                                <table class="table" ui-jq="footable" ui-options='{"paging": {"enabled": true},"filtering": {"enabled": true},"sorting": {"enabled": true}}'>
                                    ...
                                    <tr>
                                        ...
                                        <th ng-click="sortBy('tensanpham')" style="text-align:left;width: 200px">Mã Vận Đơn
                                        ...
                                        <th ng-click="sortBy('tensanpham')" style="text-align:center;">Tên Khách Hàng
                                            <span class="glyphicon" ng-show="sortColumn=='tensanpham'" ng-class="{'glyphicon-triangle-top': !reverse, 'glyphicon-triangle-bottom': reverse}"></span>
                                        </th>
                                        <th ng-click="sortBy('product_price')" style="text-align:center;">Địa Chỉ
                                        ...
                                        <th ng-click="sortBy('soluong')" style="text-align:center;">Số Điện Thoại
                                        ...
                                        <th ng-click="sortBy('khuyenmai')" style="text-align:center;width: 128px;">Trạng Thái
                                    ...
                                    <tbody>
                                    <tr style="text-align: center" ng-repeat="or in orders | filter:search | limitTo: itemsPerPage: (currentPage - 1) * itemsPerPage| orderBy: sortColumn: reverse ">
                                        <td style="vertical-align:middle;">@{{$index+1}}</td>
                                        <td style="vertical-align:middle;text-align: left"><b><i class="fas fa-qrcode"></i> @{{or.bill_orderid}}<br><i class="far fa-clock"></i> @{{or.bill_datesend}}</b></td>
                                        <td style="vertical-align:middle;">@{{or.bill_fullname}}</td>
                                        <td style="vertical-align:middle;">@{{or.bill_address}}</td>
                                        <td style="vertical-align:middle;">@{{or.bill_phonenumber}}</td>
                                        <td style="vertical-align:middle;"  ng-click="savedata1(or.id)" ng-if="or.bill_status==0"><button style="border-radius: 5px;border-color: #c03f1f;padding: 2px;background: #c03f1f;color: white">Chờ xác nhận</button></td>
                                        <td style="vertical-align:middle;" ng-if="or.bill_status==2"><button style="border-radius: 5px;border-color: #e38e2f;padding: 2px 13px;background: #e38e2f;color: white">Đang Giao</button></td>
                                        <td style="vertical-align:middle;" ng-if="or.bill_status==4"><button style="border-radius: 5px;border-color: #cb2222;padding: 2px 24px;background: #cb2222;color: white">Đã Hủy</button></td>
                                        <td style="vertical-align:middle;" ng-if="or.bill_status==3"><button style="border-radius: 5px;padding: 2px 9px;background: #1ba80a;border-color: #1ba80a;color: white">Hoàn Thành</button></td>
                                        <td style="vertical-align:middle;" ng-if="or.bill_status==5"><button style="border-radius: 5px;padding: 2px 17px;background: #4b4d4b;color: white">Hoàn Trả</button></td>
                                            ...
                                            <div class="top-nav clearfix" style="margin-top: 5px;">
                                                <ul class="nav pull-right top-menu">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu extended logout">
                                                            <li><a href="/admin/detailorder/@{{or.bill_orderid}}"><i class="fas fa-eye"></i>Xem Chi Tiết Hóa Đơn</a></li>
                                                            <li><a href="#"><i class="far fa-thumbs-up"></i> Hoạt Động</a></li>
                                                            <li><a href="#"><i class="far fa-thumbs-down"></i> Ngừng Hoạt Động</a></li>
                                                            <li ng-click="deleteClick(or.id)"><a href="#"><i class="fas fa-eraser"></i>Xóa</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <tr ng-if="!orders || (orders | filter: search).length == 0">
...
<script src="{!! asset('/angularjs/admin/ordercontroller.js')!!}"></script>
